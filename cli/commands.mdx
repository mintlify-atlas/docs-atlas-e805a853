...
description: "Reference for all stlite CLI commands: share encodes projects as URLs, html exports self-contained files, web creates offline bundles, desktop builds Electron artifacts."
---
...
<ParamField query="--pyodideSource" type="string">
