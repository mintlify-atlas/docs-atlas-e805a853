---
title: "Top-Level Await in Stlite: Using Async Code in Streamlit Apps"
sidebarTitle: "Top-Level Await"
description: "Stlite supports top-level await because the browser event loop is always running. Learn when to use it instead of asyncio.run(), with asyncio.sleep and pyfetch examples."
---
