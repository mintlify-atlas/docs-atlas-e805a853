...
description: "Use the <streamlit-app> HTML custom element to embed Stlite apps declaratively. Supports inline Python, multi-file apps, requirements, and SharedWorker mode."
---
