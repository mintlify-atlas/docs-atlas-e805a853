...
description: "Full API reference for mount() in @stlite/browser: all options including entrypoint, files, archives, streamlitConfig, env, and the returned controller."
---
...
<ParamField path="addMockPackage(name, version, modules?, persistent?)" type="function">
