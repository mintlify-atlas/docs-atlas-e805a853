...
<ParamField path="installs" type="Array<{ requirements: string[]; options?: MicropipInstallOptions }>">
...
<ParamField path="moduleAutoLoad" type="boolean">
...
<ParamField path="hostConfigProperties" type="IHostConfigProperties">
