...
description: "@stlite/desktop converts your Streamlit app into an Electron desktop app using Pyodide. No Python install required on the end-user's machine."
---
