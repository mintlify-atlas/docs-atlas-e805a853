...
description: "Step-by-step guide to building a Streamlit Electron desktop app: set up package.json, write your app, run the dump command, preview, and package for distribution."
---
