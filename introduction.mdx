...
description: "Stlite uses Pyodide (WebAssembly CPython) to run Streamlit apps client-side with no server. Learn how it works and which package fits your use case."
---
